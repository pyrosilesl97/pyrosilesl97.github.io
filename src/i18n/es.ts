...
export const es: Translation = {
  ...
  hero: {
    ...
    updated: 'Actualizado en mayo 2026',
  },
  about: {
    title: 'Sobre mí',
    kicker: 'Perfil',
  ...
  contact: {
    ...
    kicker: 'Contacto',
    body: 'Abierto a proyectos de full-stack, ingeniería de IA y bioinformática, freelance o de tiempo completo. Déjame un mensaje y te respondo.',
    nameLabel: 'Nombre',
